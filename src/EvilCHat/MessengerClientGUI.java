...
// Anfang Attribute
	...
	private final int CONST_SERVERPORT = 20018;
	private MessengerClient messengerClient;

	public MessengerClientGUI(String pServerIP, int pServerPort) {
		...
		messengerClient = new MessengerClient(pServerIP, pServerPort, this);
