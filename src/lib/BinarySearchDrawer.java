...
import SymMan.ZeichenMitAnzahl;
 ...
 * @Version 2014-03-13
 */
public class BinarySearchDrawer extends Frame {

	private BinarySearchTree _baum;
	private BufferedImage img;
	private Graphics g;
	private int _dy; // Abstand der Baumebenen
	private String suchName = "";

	public BinarySearchDrawer(int frameWidth, int frameHeight, BinarySearchTree binarySearchTree) {
		super("BinarySearchTree");
		_baum = binarySearchTree;
